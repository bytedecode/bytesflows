...
1. Are browser-rendered pages counted differently?
1. What happens after trial traffic is used?
1. Can we start small without a large commitment?
Acceptable signal:
...
1. What acceptable-use rules apply?
1. What workflows are not allowed?
1. Who reviews abuse reports or policy questions?
1. Can the provider support a legitimate business use case without overpromising?
Acceptable signal:
...
1. Can the provider support those markets consistently?
1. How do we measure wrong-market output?
1. What is the useful-output rate on our target sample?
Acceptable signal:
...
1. Can browser workflows keep one route for one task?
1. How long can a sticky session last?
1. Can sessions be tied to country or city targeting?
1. What happens when a route fails mid-session?
Acceptable signal:
...
1. Can we test browser and non-browser paths separately?
1. Can we validate multiple markets?
1. Can we measure retries and traffic per useful output?
1. Can we test support before buying?
Acceptable signal:
...
1. Does our runtime support the provider's auth format?
1. Does the provider document setup for Puppeteer, Playwright, Python, or our worker runtime?
1. Can we test protocols separately in trial?
Acceptable signal:
...
1. How do we report route quality issues?
1. What information should we include in a support ticket?
1. How quickly does technical support respond?
1. Can support help diagnose workflow fit, not just credentials?
Acceptable signal:
...
1. Which failures are counted separately?
1. What is the wrong-market rate?
1. What is the cost per useful output?
1. Which route or session mode produced the best result?
Acceptable signal:
...
1. Do they explain allowed and disallowed uses?
1. Do they talk about output validation?
1. Do they acknowledge that some targets or workflows are not appropriate?
Acceptable signal:
...
1. Which countries, cities, protocols, and session modes are required?
1. What does a useful output mean for this workflow?
1. What is the expected traffic per useful output?
1. What failures are excluded from reporting?
1. How does the provider explain residential sourcing and acceptable use?
1. Can we start with a small plan or trial?
1. Can support diagnose route and session issues?
1. What happens if wrong-market output increases?
1. What would make us reject this provider after trial?
