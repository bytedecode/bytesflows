...
This guide pairs well with [Web Scraping vs API Data Collection](https://bytesflows.com/blog/web-scraping-vs-api), [Browser Automation for Web Scraping](https://bytesflows.com/blog/browser-automation-web-scraping), and [Best Proxies for Web Scraping](https://bytesflows.com/blog/best-proxies-for-web-scraping).
...
Use [Scraping Test](https://bytesflows.com/tools/proxy-test), [HTTP Header Checker](https://bytesflows.com/blog/http-header-checker), and [Proxy Checker](https://bytesflows.com/blog/proxy-checker) when website access is part of the stack.
## Common Mistakes
...
## Further reading
- [Web Scraping vs API Data Collection](https://bytesflows.com/blog/web-scraping-vs-api)
