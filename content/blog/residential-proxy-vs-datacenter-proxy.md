...
2. Does the target treat datacenter routes differently?
3. Is speed or realism more important?
4. Does the workflow need browser rendering?
5. Does the task need sticky session continuity?
6. What failure rate is acceptable?
7. What is the traffic per useful output?
8. What happens if the data is wrong?
9. Can datacenter handle discovery while residential handles validation?
10. Is the use case appropriate and policy-reviewed?
