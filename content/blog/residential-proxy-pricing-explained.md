...
2. Run them through the same crawler or browser stack you plan to use in production.
3. Record average transferred bytes, success rate, retry rate, and time per completed output.
4. Multiply by URL count, market count, device assumptions, and refresh cadence.
5. Add a buffer for target changes, failed deploys, and monitoring screenshots.
